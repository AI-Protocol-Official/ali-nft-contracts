# AI Protocol ERC721 Token #
AI Protocol NFT is an ERC721 token used as a target NFT for iNFT protocol.
...
* [ALINFT](contracts/token/ALINFT.sol) – ERC721 token implementation
...
1. Clone the repository  
    ```git clone git@github.com:AI-Protocol-Official/ali-nft-contracts.git```
2. Navigate into the cloned repository  
    ```cd ali-nft-contracts```
